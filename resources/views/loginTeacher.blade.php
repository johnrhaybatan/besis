...
<div class="login-container">
    ...
    <form class="/loginTeacher" method="push">
        ...
        <div class="form-group">
            <input type="text" id="email" name="email" placeholder="Teacher Employee ID or Email" required
                class="form-control">
        ...
        <div class="form-group text-center">
            <a href="/TeacherRegister" class="btn btn-link">Register</a>
